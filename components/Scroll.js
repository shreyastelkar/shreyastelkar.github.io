        ...
        <div ref={sectionRef} className="scroll-section-inner">
          ...
          <div className="scroll-section1 bg-[#db3a3a] flex">
            ...
            <div className="text-white flex-1 mt-48 ">
              <ul className="bg-black list-disc pl-2 text-center font-semibold mr-12 xl-2xl lg:text-xl md:text-xl sm:text-xl rounded">
                <li>
                  Platform game on
                  <span className="text-[#319443] font-bold">
                    FPGA BASYS3
                  </span>{" "}
                  board that features a coin-collecting and pitfall-avoiding
                  aspect with charged jumping mechanics.
                </li>
                <li>
                  Designed with State machines, Sequential Logic, Counters, and
                  Flip-Flops and displayed on the monitor with VGA. Implemented
                  a large-scale system with smaller logic components.
                </li>
              </ul>

              <h1
                className="text-white text-2xl md:text-xl sm:text-xl font-semibold mt-12 bg-black rounded min-content"
          ...
          <div className="scroll-section1 bg-[#464343] text-black">
            ...
            <ul className="list-disc pl-2 text-white ml-24 font-semibold lg:text-3xl md:text-xl">
              <li>
                Finds the shortest hamiltonian path in C using the graph and
                path methods.
              </li>
          ...
          <div className="scroll-section1 bg-[#3d4842]">
            <div className="container1">
              <div className="mt-24 ml-24">
                <div className="container">
                  <h1 className="text-[#4dd48f] text-bold text-4xl mb-8">
                    {" "}
                    Morse Code Decoder{" "}
                  </h1>
                  <span>
                ...
                <ul className="text-[#edd6d6] font-bold text-2xl mb-4 pl-2 list-disc">
                  <li>
                    {" "}
                    Photosensor programmed by an ESP32C3 reads in dots and
                    dashes from an LED
                  </li>
                  <li>
                    {" "}
            ...
            <div className="flex-1 py-24">
              <div className="container">
                ...
                <Image src="/led.jpeg" width={250} height={200} />
              </div>
            </div>
          </div>
        </div>
